 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "event-stream", "debounce", "gulp-filter", "gulp-rename", "path", "fs", "rimraf", "./git", "vinyl"], function (require, exports, es, debounce, _filter, rename, path, fs, _rimraf, git, VinylFile) {
    'use strict';
