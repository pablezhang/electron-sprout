...
import * as path from 'sprout/base/common/path';
import * as fs from 'fs';
import { promisify } from 'util';
import * as cp from 'child_process';
import * as nls from 'sprout/nls';
import * as Types from 'sprout/base/common/types';
import { IStringDictionary } from 'sprout/base/common/collections';
import * as Objects from 'sprout/base/common/objects';
import * as extpath from 'sprout/base/common/extpath';
import * as Platform from 'sprout/base/common/platform';
import { LineDecoder } from 'sprout/base/node/decoder';
import { CommandOptions, ForkOptions, SuccessData, Source, TerminateResponse, TerminateResponseCode, Executable } from 'sprout/base/common/processes';
import { getPathFromAmdModule } from 'sprout/base/common/amd';
...
export function terminateProcess(process: cp.ChildProcess, cwd?: string): TerminateResponse {
	if (Platform.isWindows) {
		...
		try {
			const cmd = getPathFromAmdModule(require, 'sprout/base/node/terminateProcess.sh');
