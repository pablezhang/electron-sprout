 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "sprout/base/common/path", "fs", "util", "child_process", "sprout/nls", "sprout/base/common/types", "sprout/base/common/objects", "sprout/base/common/extpath", "sprout/base/common/platform", "sprout/base/node/decoder", "sprout/base/common/amd"], function (require, exports, path, fs, util_1, cp, nls, Types, Objects, extpath, Platform, decoder_1, amd_1) {
    "use strict";
    ...
    function terminateProcess(process, cwd) {
        if (Platform.isWindows) {
            ...
            try {
                const cmd = amd_1.getPathFromAmdModule(require, 'sprout/base/node/terminateProcess.sh');
