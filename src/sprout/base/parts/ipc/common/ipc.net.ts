...
import { IMessagePassingProtocol, IPCClient } from 'sprout/base/parts/ipc/common/ipc';
import { IDisposable, Disposable, dispose } from 'sprout/base/common/lifecycle';
import { VSBuffer } from 'sprout/base/common/buffer';
import * as platform from 'sprout/base/common/platform';
import * as process from 'sprout/base/common/process';
