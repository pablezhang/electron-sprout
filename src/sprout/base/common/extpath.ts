...
import { startsWithIgnoreCase, equalsIgnoreCase, endsWith, rtrim } from 'sprout/base/common/strings';
import { CharCode } from 'sprout/base/common/charCode';
import { sep, posix, isAbsolute, join, normalize } from 'sprout/base/common/path';
