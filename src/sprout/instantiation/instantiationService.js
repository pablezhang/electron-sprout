define(["require", "exports", "./graph", "./instantiation", "./descriptors", "./serviceCollection", "sprout/base/common/async"], function (require, exports, graph_1, instantiation_1, descriptors_1, serviceCollection_1, async_1) {
    "use strict";
    ...
    class InstantiationService {
        ...
        */
        ...
        _createInstance(ctor, args = []) {
            ...
            let serviceDependencies = instantiation_1.serviceIdManager.getServiceDependencies(ctor).sort((a, b) => a.index - b.index);
            let serviceArgs = [];
